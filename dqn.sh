...
python dqn.py --seed 0 --n_episodes 5_000 --start_epsilon 0.9 --learning_rate 1e-3 --batch_size 64 --discount_factor 0.95 --replay_size 10_000 --logging_interval 10 --hidden_size 64 --dropout_rate 0.1 --weight_decay 0.01 --target_network_update 100 --alpha 1 --auxiliary False --intermediate_reward 0 --final_reward 0 --wandb
